    ...
    <Card className='!shadow-none p-0'>
      <CardContent sx={{ pb: '0 !important' }}>
        <form onSubmit={handleSubmit(onPasswordFormSubmit)}>
                        ...
                        <OutlinedInput
                          ...
                          sx={{
                            ...
                            '&:hover .MuiOutlinedInput-notchedOutline': {
                              borderColor: '#F2660D' // Border color on hover
                            }
                          }}
                        />
                      )}
          ...
          <Grid item className='!mt-9 !mb-3' xs={12}>
            <Button variant='contained' type='submit' sx={{ mr: 3 }} className='!bg-secondColor hover:!bg-secondColor'>
              Enregistrer
            </Button>
